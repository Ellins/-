...
function Dialog( dragId , moveId ){
 ...
 function showDialog_login(){
    ...
    fillToBody( g('mask2') );
    g('registerPage').style.display = 'none';
    g('masks').style.display = 'none';
  }

  //  关闭对话框
  function hideDialog_register(){
    g('dialogMove').style.display = 'none';
    g('masks').style.display = 'none';
  }
    function hideDialog_login(){
    g('dialogMove2').style.display = 'none';
    g('mask2').style.display = 'none';
  }
window.onload=function(){
  g('masks').onclick=hideDialog_register;
   g('mask2').onclick=hideDialog_login;
}
  //  侦听浏览器窗口大小变化
